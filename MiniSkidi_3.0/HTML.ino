...
<html>
  <head>
  user-scalable=no//Thank you Daniel, I salute you.
  <style>
    .arrows {
      font-size:50px;
      color:grey;
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      <tr>
        <td></td>
        <td class="button" ontouchstart='sendButtonInput("MoveSkidi","1")'onmousedown='sendButtonInput("MoveSkidi","1")'onmouseup='sendButtonInput("MoveCar","0")' ontouchend='sendButtonInput("MoveCar","0")'><span class="arrows" >&#8679;</span></td>
        <td></td>
      </tr>
      <tr>
        <td class="button" ontouchstart='sendButtonInput("MoveSkidi","3")'onmousedown='sendButtonInput("MoveSkidi","3")'onmouseup='sendButtonInput("MoveCar","0")' ontouchend='sendButtonInput("MoveCar","0")'><span class="arrows" >&#8678;</span></td>
        <td class="button"></td>    
        <td class="button" ontouchstart='sendButtonInput("MoveSkidi","4")'onmousedown='sendButtonInput("MoveSkidi","4")'onmouseup='sendButtonInput("MoveCar","0")' ontouchend='sendButtonInput("MoveCar","0")'><span class="arrows" >&#8680;</span></td>
      </tr>
      <tr>
        <td></td>
        <td class="button" ontouchstart='sendButtonInput("MoveSkidi","2")'onmousedown='sendButtonInput("MoveSkidi","2")'onmouseup='sendButtonInput("MoveCar","0")' ontouchend='sendButtonInput("MoveCar","0")'><span class="arrows" >&#8681;</span></td>
        <td></td>
      </tr>
      <tr/>
      <tr/>
      <tr/><tr/>
      <tr>
        <td class="button" ontouchstart='sendButtonInput("MoveSkidi","6")'onmousedown='sendButtonInput("MoveSkidi","6")'onmouseup='sendButtonInput("MoveCar","0")' ontouchend='sendButtonInput("MoveCar","0")'><span class="arrows" >&#8678;</span></td>
        <td class="button"></td>    
        <td class="button" ontouchstart='sendButtonInput("MoveSkidi","5")'onmousedown='sendButtonInput("MoveSkidi","5")'onmouseup='sendButtonInput("MoveCar","0")' ontouchend='sendButtonInput("MoveCar","0")'><span class="arrows" >&#8680;</span></td>
      </tr>
      <tr/>
      <tr/>
      <tr/><tr/>
